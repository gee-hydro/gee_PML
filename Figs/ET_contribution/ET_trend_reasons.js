...
var ImgCol_gldas = ee.ImageCollection("projects/pml_evapotranspiration/PML_INPUTS/GLDAS_v21_8day"),
    ...
    imgcol_gldas_v20 = ee.ImageCollection("NASA/GLDAS/V20/NOAH/G025/T3H"),
...
var imgcol_temp         = pkg_trend.imgcol_addSeasonProb(imgcol_pgf);
var imgcol_pgf_annual = pkg_trend.aggregate_prop(imgcol_temp, "YearStr", 'mean');

print(pkg_trend.imgcol_last(imgcol_pgf));
print(imgcol_pgf_annual.limit(3));
...
var t_pgf_wind = calYearlyTrend(imgcol_pgf_annual, 'wind_mean');
...
Map.addLayer(t_pgf_wind  , vis_slp, 'pgf wind during 1980-2016');
