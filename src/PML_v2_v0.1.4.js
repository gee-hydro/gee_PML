...
//  Update 05 Sep, 2018; kongdd
// var Alpha_raw = ee.List([0.000, 0.060, 0.084, 0.060, 0.057, 0.060,
// 		0.029, 0.029, 0.065, 0.035, 0.060, 0.032,
// 		0.032, 0.060, 0.032, 0.000, 0.060, 0.000]);
// var Thelta_raw = ee.List([0.000, 0.042, 0.030, 0.042, 0.028, 0.040,
// 		0.063, 0.063, 0.041, 0.049, 0.040, 0.069,
// 		0.069, 0.040, 0.069, 0.000, 0.040, 0.000]);
// var m_raw = ee.List([0.000, 2.659, 3.840, 2.659, 4.492, 3.562,
// 		2.000, 2.000, 3.000, 3.395, 2.289, 17.238,
// 		3.312, 3.562, 3.312, 0.000, 2.289, 0.000]);
// var Am_25_raw = ee.List([0.000, 120.000, 21.395, 120.000, 18.480, 70.918,
// 		72.802, 72.802, 34.500, 53.141, 80.113, 18.482,
// 		97.662, 70.918, 97.662, 0.000, 80.113, 0.000]);
// var D0_raw = ee.List([0.200, 0.243, 0.273, 0.243, 0.340, 0.535,
// 		0.152, 0.152, 0.338, 0.230, 0.368, 0.102,
// 		0.215, 0.535, 0.215, 0.200, 0.368, 0.200]);
// var kQ_raw = ee.List([0.600, 1.000, 0.976, 1.000, 0.613, 0.836,
// 		0.730, 0.730, 0.923, 1.000, 0.834, 0.625,
// 		0.101, 0.836, 0.101, 0.600, 0.834, 0.600]);
// var kA_raw = ee.List([0.700, 0.753, 0.501, 0.753, 0.899, 0.669,
// 		0.899, 0.899, 0.770, 0.899, 0.899, 0.899,
// 		0.899, 0.669, 0.899, 0.700, 0.899, 0.700]);
// var S_sls_raw = ee.List([0.000, 0.243, 0.147, 0.243, 0.108, 0.170,
// 		0.030, 0.030, 0.212, 0.147, 0.179, 0.010,
// 		0.151, 0.170, 0.151, 0.000, 0.179, 0.000]);
// var fER0_raw = ee.List([0.000, 0.045, 0.080, 0.045, 0.031, 0.010,
...
var Alpha_raw = ee.List([0.000, 0.036, 0.063, 0.036, 0.029, 0.031,
		0.033, 0.033, 0.065, 0.038, 0.061, 0.048,
		0.029, 0.031, 0.029, 0.000, 0.061, 0.000]);
var Thelta_raw = ee.List([0.000, 0.047, 0.015, 0.047, 0.020, 0.028,
		0.038, 0.038, 0.024, 0.069, 0.024, 0.040,
		0.070, 0.028, 0.070, 0.000, 0.024, 0.000]);
var m_raw = ee.List([0.000, 12.715, 10.563, 12.715, 11.748, 12.387,
		10.621, 10.621, 11.000, 11.861, 13.331, 32.773,
		10.294, 12.387, 10.294, 0.000, 13.331, 0.000]);
var Am_25_raw = ee.List([0.000, 15.877, 20.732, 15.877, 10.982, 15.939,
		11.363, 11.363, 11.500, 7.254, 15.879, 14.125,
		19.655, 15.939, 19.655, 0.000, 15.879, 0.000]);
var D0_raw = ee.List([0.700, 0.266, 0.500, 0.266, 0.475, 0.271,
		0.297, 0.297, 0.338, 0.514, 0.184, 1.000,
		0.479, 0.271, 0.479, 0.700, 0.184, 0.700]);
var kQ_raw = ee.List([0.600, 0.853, 0.875, 0.853, 0.464, 0.605,
		0.320, 0.320, 0.820, 1.000, 0.831, 0.910,
		0.100, 0.605, 0.100, 0.600, 0.831, 0.600]);
var kA_raw = ee.List([0.700, 0.899, 0.900, 0.899, 0.899, 0.667,
		0.899, 0.899, 0.895, 0.899, 0.899, 0.899,
		0.900, 0.667, 0.900, 0.700, 0.899, 0.700]);
var S_sls_raw = ee.List([0.000, 0.106, 0.109, 0.106, 0.069, 0.127,
		0.010, 0.010, 0.158, 0.047, 0.099, 0.014,
		0.010, 0.127, 0.010, 0.000, 0.099, 0.000]);
var fER0_raw = ee.List([0.000, 0.054, 0.088, 0.054, 0.014, 0.010,
		0.010, 0.010, 0.096, 0.053, 0.018, 0.014,
		0.159, 0.010, 0.159, 0.000, 0.018, 0.000]);
